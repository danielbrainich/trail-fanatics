        ...
        <div className="col-md-7 d-flex flex-column flex-fill">
          <div>
            <ul className="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li className="nav-item" role="presentation">
                <button className="nav-link" id="trails-near-me-tab" data-bs-toggle="tab" data-bs-target="#trails-near-me-tab-pane" type="button" role="tab" aria-controls="trails-near-me-tab-pane" aria-selected="true">Trails Near Me</button>
              </li>
              <li className="nav-item" role="presentation">
          ...
          <div className="tab-pane fade" id="trails-near-me-tab-pane" role="tabpanel" aria-labelledby="trails-near-me-tab" tabIndex="0">
            <div className="mt-3">This where I can see trails near me</div>
          </div>
          <div className="tab-pane fade" id="saved-trails-tab-pane" role="tabpanel" aria-labelledby="saved-trails-tab" tabIndex="0">
            <div className="mt-3">This is where I can see trails I've saved</div>
          </div>
        </div>
      </div>
    </div>
